...
Version : 1
Author : Jaime Gomez
Link : https://pandas.pydata.org/pandas-docs/stable/reference/api/pandas.DataFrame.plot.html?highlight=plot#pandas.DataFrame.plot
...
print("---------------------------------")
#archivo_csv = "data/WEO_Data_Latinoamerica_2020.csv"
#df = pd.read_csv(archivo_csv, thousands=',', decimal='.')
archivo_csv = "Tecsup/modulo2/semana3/codigos_graficos_02.UPDATE/data/WEO_Data_Latinoamerica_2021.csv"
df = pd.read_csv(archivo_csv, thousands=',', decimal='.', delimiter=";")
print(df.head())
